...
# When people come to the homepage where do they come from??
# Need to breakdown traffic into subsections
# 1. Need records of the pageviews on the homepage ie where the title is watsi
# 2. Created new dataframe###
